...
public class HomeFragment extends Fragment {
    ...
    private void setupListeners(View view) {
        ...
        view.findViewById(R.id.card_accounting).setOnClickListener(v -> {
            Toast.makeText(getContext(), "بخش حسابداری فیروزه", Toast.LENGTH_SHORT).show();
        });

        view.findViewById(R.id.card_inventory).setOnClickListener(v -> {
            Toast.makeText(getContext(), "بخش انبارداری فیروزه", Toast.LENGTH_SHORT).show();
        });

        view.findViewById(R.id.card_ai).setOnClickListener(v -> {
        ...
        view.findViewById(R.id.card_reports).setOnClickListener(v -> {
            Toast.makeText(getContext(), "بخش گزارشات فیروزه", Toast.LENGTH_SHORT).show();
        });
    }
